...
export const PracticeEditCard = ({ toggleOpen }: PracticeCardProps) => {
  ...
  return (
    <>
      ...
      <Card
        className={cn(
          '!rounded-xl dark:!bg-pop-pink dark:!text-primary !fixed overflow-hidden mx-4 py-2 top-1/3 inset-x-0 z-30',
        )}
      ...
      >
        <CardBody as={motion.div} className="flex flex-col justify-start">
          ...
          <Flex className="justify-between">
            ...
            <Flex className="studio bg-login">Login</Flex>
            <Flex>Terms and condditions apply</Flex>
